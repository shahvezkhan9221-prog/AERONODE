    ...
    <main className="app-shell">
      <header className="app-header glass">
        ...
        <div className="header-actions">
          <div className={`security-pill ${gatewayFirmware === "mp3-transfer-v5" ? "verified" : ""}`}><i>◆</i><span><small>{gatewayFirmware === "mp3-transfer-v5" ? "MP3 TRANSFER READY" : "FIRMWARE CHECK"}</small>{gatewayFirmware === "mp3-transfer-v5" ? gatewayTransport : gatewayFirmware}</span></div>
